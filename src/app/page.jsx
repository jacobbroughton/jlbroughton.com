    ...
    <Layout>
      <div className={styles.container}>
        ...
        <section className={styles.about}>
          ...
          <p>
            I am an experienced web developer that has built and shipped applications that
            have reached 100k+ unique users and are still used each day after several
            years. I primarily work with front-end technologies such as React & GraphQL.
            Here are some of my <Link href="/portfolio">personal projects</Link>.
          </p>
          <p>
            <button
